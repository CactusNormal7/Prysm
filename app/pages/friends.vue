  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <div v-else-if="searchQuery.length >= 2 && !searching && searchResults.length === 0" class="empty-state">
        <p>No corresponding user found</p>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div v-else-if="(friendRequests?.received?.length || 0) === 0 && (friendRequests?.sent?.length || 0) === 0" class="empty-state">
...
const handleKeydown = (event: KeyboardEvent) => {
  // Prevent tab and other problematic characters
...
const handleSearch = async () => {
  // Clean the search query (remove tabs and extra whitespace)
